...
extension ViewController: UITableViewDataSource{
    ...
    @objc func likeClicked(sender: UIButton){
        ...
        //a user cannot like own message
        //a user can only like a message only once
        
        //get the likes array
        //check to see if the current user is the sender and return
        //check to see if the current user has liked the message previously, then return
        //append the current user into the likes array
        //assign the array back to the likes key and save in background
